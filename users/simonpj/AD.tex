...
{\bf Derivatives of built-in functions}
      ...
      \begin{array}{rcl}
        ...
        \gradf{\indexfun{\cdot}{\cdot}}(v,i) & = & \lmbuildt( \sizefun(v),
               \lambda j. \lstinline|if|\, i=j \,\lstinline|then|\, \lmone  \, \lstinline|else|\, \lmzero ) \lmjoin \lmzero \\[2mm]
...
$$
\begin{array}{l}
\sumfun{\buildfun( n, \lambda i.\, \lstinline|if| \, i == e_i \,
     \lstinline|then| \, e \, 
     \lstinline|else| \, 0 )} \\
\quad = \;\; \lstinline|let|\, i = e_i \, \lstinline|in|\, b \\
\mbox{if} \; i \not\in e_i
\end{array}
$$
I hate this!
