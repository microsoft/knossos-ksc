...
\begin{codearray}{ll}
  \mbox{\bf Original function}   & f : S \to T \\
  & f(s) = e \\[1mm]
  \mbox{\bf Forward BOG}  & \fbog{f} : S \to (T,\bog{e}) \\
  & \fbog{f}(s) = \gradfbog{e} \\[1mm]
\end{codearray} \\
$$
...
$$
      \begin{array}{rcll}
        ...
        \gradfbog{x} & = & (x,()) \\
%
        \gradfbog{f(e)} & = & \begin{codearray}{l}
          \mbox{\lstinline|let $\;(a,b_1) = \gradfbog{e}\;$ in|} \\
          \mbox{\lstinline|let $\;(r,b_2) = \fbog{f}(a)\;$ in|} \\
          (r, (b_1,b_2))
          \end{codearray} \\
%
        \gradfbog{(e_1,e_2)} & = & \begin{codearray}{l}
...
%
        ...
        & = & \begin{codearray}{l}
           ...
           \end{codearray} \\
%
       \gradfbog{\mbox{\lstinline|build $\;e_1\;(\lambda i.\, e_2)$ |}} & = \vspace{-2mm}\\
       \multicolumn{3}{l}{\qquad \begin{codearray}{lll}
         \mbox{\lstinline|let $\;n = e_1\;$ in|} \\
         \mbox{\lstinline|let $\;(r,ba)\;$ = unzip (build $\;n\;(\lambda i.\,\gradfbog{e_2})$) in|} \\
           (r, (n,ba))
           \end{codearray}} \\
%
       \multicolumn{3}{l}{\gradfbog{\mbox{
             \lstinline|case $\;e_1\;$ of \{ Inl x $\rightarrow e_2$; Inr y $\rightarrow e_3$ \}|}} = \vspace{-2mm}}
      \\
       \multicolumn{3}{l}{\begin{codearray}{l}
...
\begin{codearray}{ll}
  \mbox{\bf Original function}   & f : S \to T \\
  & f(s) = e \\[1mm]
  \mbox{\bf Reverse BOG}  & \rbog{f} : (\tangent{T},\bog{e}) \to \tangent{S} \\
  & \rbog{f}(\gradf{t},b) = \mbox{\lstinline|let $\gradrbog{e}{\gradf{t}}{b}\;$ in $\;\gradf{x}$|}
\end{codearray} \\
$$
...
$$
      \begin{array}{rcll}
        \gradrbog{k}{\gradf{t}}{b} & = & \{ \} \\
%
        \gradrbog{x}{\gradf{t}}{b} & = & \{ \gradf{x} = \gradf{t} \} \\
%
        \gradrbog{f(e)}{\gradf{t}}{b} & = & \begin{codearray}{lll}
          \{ & (b_1,b_2) = b \\
          ;  & \gradf{a} = \rbog{f}(\gradf{t},b_2) & \} \\
          \multicolumn{3}{l}{\append \; \gradrbog{e}{\gradf{a}}{b_1}}
          \end{codearray} \\
%
        \gradrbog{(e_1,e_2)}{\gradf{t}}{b} & = &
                   \begin{codearray}{lll}
          ...
          \end{codearray} \\
%
        \gradrbog{\mbox{\lstinline|let $\;x$ = $e_1\;$ in $\;e_2$|}}{\gradf{t}}{b}
        & = & \begin{codearray}{lll}
           \{ & (b_1,b_2) = b & \} \\
