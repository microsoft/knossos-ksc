...
\begin{array}{r@{\hspace{1mm}}c@{\hspace{1mm}}l}
   ...
   \clet{x}{c_r}{c_b} \capply t & = & \lstinline|let|\;x\, = \, c_r\capply t \; \lstinline{in}\; c_b \capply (t \ctupx x) \\
   \cbuild{c_s}{i}{c_e} \capply t & = & \lstinline|build|\;(c_x \capply t)\;(\lambda i. c_e \capply (t \ctupx i))
\end{array}
$$
