...
%
       \multicolumn{3}{l}{\gradfbog{\mbox{
             \lstinline|case $\;e_1\;$ of \{ Inl x $\rightarrow e_l$; Inr y $\rightarrow e_r$ \}|}} = \vspace{-2mm}}
      \\
       \multicolumn{3}{l}{\begin{codearray}{l}
       \qquad   \mbox{\lstinline|let $\;(v,b_1) = \gradfbog{e_1}\;$ in|} \\
       \qquad   \mbox{\lstinline|case $\;v\;$ of|} \\
       \qquad   \quad \mbox{\lstinline|Inl $\;x \rightarrow\;$ let $\;(r_l,b_l) = \gradfbog{e_l}\;$
                                                           in $\;(r_l,\;(b_1,$Inl$\;b_l))$|} \\
       \qquad  \quad \mbox{\lstinline|Inr $\;y \rightarrow\;$ let $\;(r_r,b_r) = \gradfbog{e_r}\;$
                                                           in $\;(r_r,\;(b_1,$Inr$\;b_r))$|} \\
           \end{codearray}}
%        \grad{\buildfun(e_n, \lambda i.e)} & = & \lmbuild(e_n, \lambda i. \grad{e})  \\
%        \grad{\lambda i \dot e} & = & \lmlam(\lambda i\dot \grad{e})
