...
\\
Expression $e$ & \multicolumn{2}{l}{Forward} & \multicolumn{3}{l}{Reverse}\\ 
\hline
% Constant, k
\doexpr k {
  (k,())
...
build with top-level function doesn't need one\footnote
{https://github.com/microsoft/knossos-ksc/pull/407}}
\doexpr{\ksbuild {e_1} i {e_2}} {
  \ksletnl n = {e_1} {
    \ksletnl \mathbf{rb} = {\ksbuild n i {\gradfbog{e_2}}} {
      \ksletnl (\mathbf{r},\mathbf{b}) = {\ksunzip{\mathbf{rb}}} {
        (\mathbf{r}, (n,\mathbf{b}))
      }
    }
  }
