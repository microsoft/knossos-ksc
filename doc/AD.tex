...
\newcommand{\cprune}[3]{\mathcal{P}[#1/#2]#3}   % CL function
...
$$
      \begin{array}{rcll}
        ...
        c & ::= & \cid & \mbox{Identity} \\
          & |   & \ck{k} & \mbox{Constant} \\
          & |   & \cprune{i_1,\ldots,i_m}{n}{c} & \mbox{Pruning} (0 \leq m \leq n) \\
...
\begin{figure}
\fbox{\begin{minipage}{\columnwidth}
\mbox{{\bf Semantics (aka conversion from \CatLang):}\; \fbox{$c \capply e = e$}}
$$
\begin{array}{r@{\hspace{1mm}}c@{\hspace{1mm}}l}
   \cid \capply t & = & t \\
   \cprune{i_1,\ldots,i_m}{n}{c} \capply t & = & c \capply (\sel{i_1}{n}(t), \ldots, \sel{i_m}{n}(t)) \\
   \ck{k} \capply t & = & k \\
   \cfun{f} \capply t & = & f(t) \\
...
\begin{figure}
  ...
  \begin{gather*}
    \infer{\Gamma \vdash \cid : S \darrow S}
          {} \qquad
    \infer{\Gamma \vdash \cprune{i_1, \ldots, i_m}{n}{c} : (s_1, \ldots, s_n) \darrow T}
          {\Gamma \vdash c : (s_{i_1},\ldots,s_{i_m}) \darrow T}
   \\[1mm]
