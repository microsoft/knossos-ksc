...
vrelu3 = knossos.elementwise()(relu3)
...
def plot_relu3_via_knossos(filename):
    import matplotlib.pyplot as plt
    import numpy as np
    ...
    # Plot reference in dotted red to show that they match up
    plt.plot(t, vrelu3_pytorch(t), "r--")

    df = torch.ones_like(t)
    # torch.autograd.functional.vjp(vrelu3, t, df)

    derivatives = vrelu3.vjp(t, df)

    plt.plot(t, derivatives, "b")
...
######################################################
## C++ implementations for benchmarking
