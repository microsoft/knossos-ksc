...
def test_untupling():
    ...
    expected = parse_expr_string("(let (temp_0 (foo x)) (let (a (get$1$2 temp_0)) (let (b (get$2$2 temp_0)) (add a b))))")
...
def test_untupling2():
    ...
    expected = parse_expr_string("""(let (temp_0 (if p 
...
def test_untupling_avoids_capture():
    def test_with_var_name(v: str):
        ...
        assert gen_name != v
        expected = parse_expr_string(f"(let ({gen_name} (foo {v})) (let (a (get$1$2 {gen_name})) (let (b (get$2$2 {gen_name})) (add a b))))")
