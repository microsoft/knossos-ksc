...
$alltests = pytest --rootdir=$PSScriptRoot\..\ts2k\ --collect-only --quiet --disable-pytest-warnings | Select-Object -skip 2 -last 1000000
...
{
    $test
    $test_output = pytest --rootdir=$PSScriptRoot\..\ts2k\ $test
