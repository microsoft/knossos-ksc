...
#define DECLARE_TYPE_TO_STRING_Pack(Tmpl)                         \
	...
	*/
	...
	inline KS_FUNCTION Tuple<> shape(allocator_base *, Bool const&) { return {}; }
	inline KS_FUNCTION Tuple<> shape(allocator_base *, Integer const&) { return {}; }
	inline KS_FUNCTION Tuple<> shape(allocator_base *, Float const&) { return {}; }
	inline KS_FUNCTION Tuple<> shape(allocator_base *, String const&) { return {}; }
	...
	inline KS_FUNCTION auto shape(allocator_base *) { return Tuple<>{}; }
	...
	template <>
	inline KS_FUNCTION Float zero(allocator *, Float const& val)
	{
		return 0.0;
	}

	template <>
	inline KS_FUNCTION Integer zero(allocator *, Integer const& val)
	{
		return 0;
	}
	...
	inline KS_FUNCTION Float ts_neg(allocator *, Float d) { return -d; }

	template <class... Us>
	inline KS_FUNCTION Tuple<Us...> ts_neg(allocator * alloc, Tuple<Us...> t) {
	...
	*/
	...
	template <class T>
	inline KS_FUNCTION Bool eq(T t1, T t2)
	{
		return t1 == t2;
	}

	template <class T>
	inline KS_FUNCTION Bool ne(T t1, T t2)
	{
		return t1 != t2;
	}
...
#define $BENCH$al$d$d$bf$b(alloc, FUN) ks::benchmark(ks::repeat([&]() { \
	...
	// ===============================  Dot ===========================================
	inline KS_FUNCTION Float ts_dot(Float t1, Float t2) { return t1 * t2; }

	template <class T>
	inline KS_FUNCTION Float ts_dot(T t1, Tuple<> t2)
	{
		return 0.0;
	}

	template <class T>
	inline KS_FUNCTION Float ts_dot(T t1, Tuple<T> t2)
	{
		return ts_dot(t1,ks::get<0>(t2));
	}

	template <class T0, class... Ts, class U0, class... Us>
	inline KS_FUNCTION Float ts_dot(Tuple<T0, Ts...> t1, Tuple<U0, Us...> t2)
	{
		return ts_dot(head(t1), head(t2)) + ts_dot(tail(t1), tail(t2));
	}

	template <size_t Dim, class T1, class T2>
	inline KS_FUNCTION Float ts_dot(tensor<Dim, T1> t1, tensor<Dim, T2> t2)
	{
		Float ret = 0;
