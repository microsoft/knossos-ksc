...
(edef ks_or Bool (Bool Bool))
(edef D$ks_or (LM (Tuple Bool Bool) Bool) (Bool Bool))
(edef Dt$ks_or (Tuple Bool (LM (Tuple Bool Bool) Bool)) (Bool Bool))
(def fwd$ks_or (Tuple)
     ((xt : Tuple Bool Bool) (dxt : Tuple Bool Bool))
     (tuple))
(def rev$ks_or (Tuple (Tuple) (Tuple))
     ((xt : Tuple Bool Bool) (d_dbool : Tuple))
     (tuple (tuple) (tuple)))

(edef ks_and Bool (Bool Bool))
(edef D$ks_and (LM (Tuple Bool Bool) Bool) (Bool Bool))
(edef Dt$ks_and (Tuple Bool (LM (Tuple Bool Bool) Bool)) (Bool Bool))
(def fwd$ks_and (Tuple)
     ((xt : Tuple Bool Bool) (dxt : Tuple Bool Bool))
     (tuple))
(def rev$ks_and (Tuple (Tuple) (Tuple))
     ((xt : Tuple Bool Bool) (d_dbool : Tuple))
     (tuple (tuple) (tuple)))
