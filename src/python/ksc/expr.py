...
class StructuredName:
    ...
    @staticmethod
    def from_str(s: str):
        # ALAN this seems incompatible with names generated by ts2ks so I'm disabling as the easiest "fix".
        # Do we want to find a different assertion, or change the name-mangling scheme there?
        #assert '$' not in s
